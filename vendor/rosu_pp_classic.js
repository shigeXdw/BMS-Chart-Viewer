 ...
 * @enum {0 | 1}
 */
const HitResultGenerator = Object.freeze({
    /**
 ...
 * @enum {0 | 1}
 */
const HitResultPriority = Object.freeze({
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        throw new Error('Use initSync with embedded WASM');
    }
    const imports = __wbg_get_imports();
...
globalThis.rosuPp = { Beatmap, Difficulty, initSync };
